        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(
                    ...
                    $"Пожалуйста, подтвердите свою учетную запись <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>по ссылке</a>.");

                StatusMessage = "Ссылка подтверждения отправлена. Пожалуйста, проверьте свою электронную почту.";
